...
namespace Functional.CQS.AOP.CommonTestInfrastructure.DummyObjects
{
	...
	/// </summary>
	public class DummyAsyncCommandHandlerThatSucceeds : IAsyncCommandHandler<DummyAsyncCommand, DummyAsyncCommandError>, IProvideInformationAboutCQSHandlerDummyImplementation
	{
