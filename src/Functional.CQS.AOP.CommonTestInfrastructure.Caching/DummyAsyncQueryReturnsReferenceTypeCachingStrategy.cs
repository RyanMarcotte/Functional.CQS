...
namespace Functional.CQS.AOP.CommonTestInfrastructure.Caching
{
	...
	/// 
	/// </summary>
	public class DummyAsyncQueryReturnsReferenceTypeCachingStrategy : IQueryResultCachingStrategy<DummyAsyncQueryReturnsReferenceType, DummyAsyncQueryReturnsReferenceTypeResult>
	{
		/// <summary>
		...
		/// <returns></returns>
		public string BuildCacheKeyForQuery(DummyAsyncQueryReturnsReferenceType query) => string.Empty;
		...
		/// <param name="query">The query.</param>
		/// <returns></returns>
		public Option<string> BuildCacheGroupKeyForQuery(DummyAsyncQueryReturnsReferenceType query) => Option.None<string>();
		...
		/// <returns></returns>
		public bool ShouldCacheResult(DummyAsyncQueryReturnsReferenceTypeResult result) => true;
	}
}