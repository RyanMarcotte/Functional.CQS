...
namespace Functional.CQS.AOP.IoC.PureDI.Caching
{
	...
	public class QueryHandlerCachingDecoratorForValueResultType<TQuery, TResult> : IQueryHandler<TQuery, TResult>
		...
		where TResult : struct
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="QueryHandlerCachingDecoratorForValueResultType{TQuery, TResult}"/> class.
		/// </summary>
		...
		public QueryHandlerCachingDecoratorForValueResultType(
		...
		public TResult Handle(TQuery query)
		{
			...
			var result = _cache.Get(cacheKey, groupKey, typeof(TResult), () =>
			{
				isCacheHit = false;
