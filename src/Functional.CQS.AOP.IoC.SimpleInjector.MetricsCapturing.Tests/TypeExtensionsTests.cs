...
namespace Functional.CQS.AOP.IoC.SimpleInjector.MetricsCapturing.Tests
{
	...
	{
		[Fact]
		public void ShouldReturnExpectedQueryAndResultTypeForDummyQueryReturnsValueTypeMetricsCapturingStrategy() => VerifyQueryMetricsCapturingStrategyType<DummyQueryReturnsValueType, DummyQueryReturnsValueTypeResult, DummyQueryReturnsValueTypeMetricsCapturingStrategy>();

		[Fact]
		public void ShouldReturnExpectedQueryAndResultTypeForDummyQueryReturnsReferenceTypeMetricsCapturingStrategy() => VerifyQueryMetricsCapturingStrategyType<DummyQueryReturnsReferenceType, DummyQueryReturnsReferenceTypeResult, DummyQueryReturnsReferenceTypeMetricsCapturingStrategy>();

		[Fact]
		public void ShouldReturnExpectedQueryAndResultTypeForDummyAsyncQueryReturnsValueTypeMetricsCapturingStrategy() => VerifyQueryMetricsCapturingStrategyType<DummyAsyncQueryReturnsValueType, DummyAsyncQueryReturnsValueTypeResult, DummyAsyncQueryReturnsValueTypeMetricsCapturingStrategy>();

		[Fact]
		public void ShouldReturnExpectedQueryAndResultTypeForDummyAsyncQueryReturnsReferenceTypeMetricsCapturingStrategy() => VerifyQueryMetricsCapturingStrategyType<DummyAsyncQueryReturnsReferenceType, DummyAsyncQueryReturnsReferenceTypeResult, DummyAsyncQueryReturnsReferenceTypeMetricsCapturingStrategy>();
